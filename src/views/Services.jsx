      ...
      >
        <div class="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p class="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            ...
            of articles that span a wide range of topics.
          </p>
        </div>
        ...
        <div class="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          <div class="relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-teal-200 p-2">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div class="space-y-2">
                <h3 class="font-bold">Expressiveness</h3>
                <p class="text-sm text-muted-foreground">
                  Express your thoughts realtime!
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-teal-200 p-2">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div class="space-y-2">
                <h3 class="font-bold">F2U</h3>
                <p class="text-sm">BlogIn is a Free To Use platform</p>
              </div>
            </div>
          </div>
          ...
          <div class="relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-teal-200 p-2">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div class="space-y-2">
                ...
                <p class="text-sm text-muted-foreground">
                  BlogIn Offers wide range of users, follow them and build
                  Community{" "}
                </p>
              </div>
            </div>
          ...
          <div class="relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-teal-200 p-2">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div class="space-y-2">
                <h3 class="font-bold">FOS</h3>
                <p class="text-sm text-muted-foreground">
                  Flourish your ideas with BlogIn
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-teal-200 p-2">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div class="space-y-2">
                ...
                <p class="text-sm text-muted-foreground">
                  We respect your privacy, Be stressFree and BlogIn
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="relative overflow-hidden rounded-lg border bg-white select-none hover:shadow hover:shadow-teal-200 p-2">
            <div class="flex h-[180px] flex-col justify-between rounded-md p-6">
              ...
              <div class="space-y-2">
                ...
                <p class="text-sm text-muted-foreground">
                  Free and paid subscriptions using BlogIn.
                </p>
              </div>
            </div>
          </div>
