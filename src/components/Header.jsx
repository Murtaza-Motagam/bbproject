...
const Header = ({ theme, handleTheme }) => {
  ...
  return (
    <nav
      className={`font-poppins w-full relative  ${
                ...
                >
                  ...
                  >
                    ...
                    <li>
                      <Link
                        to="/"
                        className="flex items-center space-x-3 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 60 30"
                    ...
                    <li>
                      <Link
                        to="/"
                        className="flex items-center space-x-3 py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          viewBox="0 0 13 9"
                    ...
                    <li>
                      <Link
                        ...
                        className="flex items-center space-x-3 py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                      >
                        <svg className="h-6 w-6" viewBox="0 0 3 2">
