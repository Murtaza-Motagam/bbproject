...
const ForgotPassword = () => {
  ...
  const handleRecoverPassword = async (e) => {
    ...
    const response = await fetch("http://localhost:5000/api/auth/forgotpassword/verifyemail", {
      method: "POST",
      headers: {
  ...
  return (
    <div className="bg-set min-h-screen flex flex-col">
      <div className="container max-w-sm mx-auto flex-1 flex flex-col items-center justify-center px-2">
        <form className="bg-white px-6 py-8 shadow-md shadow-gray-500 rounded-xl text-black w-full font-poppins">
          <h1 className="mb-8 text-2xl text-center bold-700 font-roboto">
          ...
          <div className="hidden" id="verified">
            ...
            <h1 className=" text-green-500 font-roboto text-lg mb-3 font-bold flex items-center gap-x-1">
          ...
          <div className="hidden" id="newPasswordS">
            <h1 className=" text-green-500 font-roboto text-md mb-3 font-bold flex items-center gap-x-1">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M21 12c0 1.268-.63 2.39-1.593 3.068a3.745 3.745 0 0 1-1.043 3.296 3.745 3.745 0 0 1-3.296 1.043A3.745 3.745 0 0 1 12 21c-1.268 0-2.39-.63-3.068-1.593a3.746 3.746 0 0 1-3.296-1.043 3.745 3.745 0 0 1-1.043-3.296A3.745 3.745 0 0 1 3 12c0-1.268.63-2.39 1.593-3.068a3.745 3.745 0 0 1 1.043-3.296 3.746 3.746 0 0 1 3.296-1.043A3.746 3.746 0 0 1 12 3c1.268 0 2.39.63 3.068 1.593a3.746 3.746 0 0 1 3.296 1.043 3.746 3.746 0 0 1 1.043 3.296A3.745 3.745 0 0 1 21 12Z" />
              </svg>
