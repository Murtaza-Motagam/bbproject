        ...
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <div className="flex items-center justify-center mr-4">
            ...
            <div className="relative">
              <button
                ...
                className={`text-gray-900 space-x-3 focus:none outline-none focus:outline-none font-medium rounded-lg text-sm px-2 py-2.5 text-center inline-flex items-center ${theme === "dark" ? "dark:hover:bg-gray-700 dark:text-white" : "hover:bg-gray-200"} `}
                type="button"
              >
              ...
              {isDropDownOpen && (
                <div
                  ref={dropdownRef}
                  className="absolute top-full left-0 mt-1 z-10 bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700"
                  style={{ minWidth: '10rem' }}
                >
                  <ul className="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="multiLevelDropdownButton">
                    {/* Dropdown items */}
                    <li>
                      <Link to="/" className="flex items-center space-x-3 px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 30" className="w-6 h-6">
                          <clipPath id="a">
                          ...
                          <g clipPath="url(#a)">
                            ...
                            <path d="M30 0v30M0 15h60" stroke="#fff" strokeWidth="10" /><path d="M30 0v30M0 15h60" stroke="#C8102E" strokeWidth="6" />
                          </g>
                        </svg>
                    ...
                    <li>
                      <Link to="/" className="flex items-center space-x-3 py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 13 9" className="w-6 h-6">
                          <rect width="13" height="3" fill="#FF9933" />
                          <rect width="13" height="3" fill="#ffffff" y="3" />
                          <rect width="13" height="3" fill="#138808" y="6" />
                          <circle cx="6.5" cy="4.5" r="1.2" fill="#000080" />
                          <circle cx="6.5" cy="4.5" r="1" fill="#ffffff" />
                        </svg>
                        <span>ENG - IN</span>
                      </Link>
                    </li>
            ...
            <div
              ...
              onClick={handleTheme}
              data-aos={handleTheme ? "zoom-out" : "zoom-in"} data-aos-duration="1000"
            >
              {theme === "dark" ?

                (<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-8 h-8 transition duration-400 ease-in">
          ...
          </div>
          {
            !localStorage.getItem('user-token')
              ...
              :
              <div>
                <div onClick={openModal} className="md:block xl:block lg:block hidden relative py-3 px-3 rounded-full bg-gray-600 text-white hover:bg-black cursor-pointer">
          ...
          <ul className="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-transparent md:space-x-10 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent">
            {
              !localStorage.getItem('user-token')
                ...
                : <li className="md:hidden lg:hidden xl:hidden block">
                  <Link
                    to="/myprofile"
                    className="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:p-0 mb-2 md:mb-0 lg:mb-0 xl:mb-0"
                  >
            ...
            <li>
              <Link
                to="/explore"
                className={`${location.pathname === "/explore" ? "text-gray-900 font-semibold dark:text-white" : "text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white"} block py-2 px-3 rounded   hover:font-semibold md:p-0 mb-2 md:mb-0 lg:mb-0 xl:mb-0`}
              >
                <div className="flex items-center space-x-2">
            ...
            <li>
              <Link
                to="/blogs"
                className={`${location.pathname === "/blogs" ? "text-gray-900 font-semibold dark:text-white" : "text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white"} block py-2 px-3 rounded   hover:font-semibold md:p-0 mb-2 md:mb-0 lg:mb-0 xl:mb-0`}
              >
                <div className="flex items-center space-x-2">
                  <i className="fa-solid fa-light fa-pen-nib fa-lg"></i>
                  <span>Blogs</span>
                </div>
              </Link>
            </li>
            <li>
              <Link
                to="/category"
                className={`${location.pathname === "/category" ? "text-gray-900 font-semibold dark:text-white" : "text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white"} block py-2 px-3 rounded   hover:font-semibold md:p-0 mb-2 md:mb-0 lg:mb-0 xl:mb-0`}
              >
                <div className="flex items-center space-x-2">
            ...
            <li>
              <Link
                to="/authors"
                className={`${location.pathname === "/authors" ? "text-gray-900 font-semibold dark:text-white" : "text-gray-600 hover:text-gray-900 dark:text-gray-300 dark:hover:text-white"} block py-2 px-3 rounded   hover:font-semibold md:p-0 mb-2 md:mb-0 lg:mb-0 xl:mb-0`}
              >
                <div className="flex items-center space-x-2">
