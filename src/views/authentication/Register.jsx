      ...
      <section className="bg-set min-h-screen flex items-center justify-center font-roboto">
        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          ...
          <div className="md:w-1/2 px-8 md:px-16">
            <h2 className="font-bold text-2xl text-[#002D74]">Signup in <span className="text-secondary font-extrabold font-poppins">BLOGIN</span></h2>

            <div className="mt-3 text-sm flex justify-start gap-x-2 items-center text-[#002D74]">
              <p>Already have an account?</p>
              <Link to="/login" className=" text-md hover:underline font-semibold">Login</Link>
            </div>
