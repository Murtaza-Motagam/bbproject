    ...
    return (
        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-900 dark:bg-gray-700 dark:border-gray-600">
            <div className="flex items-center justify-between px-3 py-2 border-b dark:border-gray-600">
                ...
                <button type="button" data-tooltip-target="tooltip-fullscreen" className="p-2 text-gray-200 rounded cursor-pointer sm:ms-auto hover:text-gray-900 hover:bg-gray-100 dark:text-gray-400 dark:hover:text-white dark:hover:bg-gray-600">
