...
const Login = () => {
  ...
  const handleLogin = async (e) => {
    ...
    const isAdmin = adminDetails.some(admin =>
      admin.adminEmail === credentials.emailId && admin.password === credentials.password
    );
    ...
    if (isAdmin) {
      ...
      if (json.success) {
        ...
        document.getElementById('emailInput').style.borderColor = "rgb(34 197 94)";
        document.getElementById('passwordInput').style.borderColor = "rgb(34 197 94)";
        ...
        document.getElementById('emailInput').style.borderColor = "rgb(185 28 28)";
        document.getElementById('passwordInput').style.borderColor = "rgb(185 28 28)";
      }
    }
  };
  ...
  return (
    <>
      <section className="bg-set min-h-screen flex items-center justify-center font-roboto">
        ...
        <div className="bg-gray-100 flex rounded-2xl shadow-lg max-w-3xl p-5 items-center">
          ...
          <div className="md:w-1/2 px-8 md:px-16">
            ...
            <p className="text-sm mt-4 text-[#002D74]">If you are already a member, get logged in by giving your credentials.</p>

            <form action="" className="-mt-3 flex flex-col gap-4" onSubmit={handleLogin}>
              ...
              <div className=" text-sm text-center hover:underline py-4 text-[#002D74]">
            ...
            <div className="mt-5 text-center text-sm flex gap-x-2 justify-center items-center text-[#002D74]">
              <p>Don't have an account?</p>
              <Link to="/register" className="shadow-sm hover:underline font-bold">Register</Link>
            </div>
          </div>
      ...
      {/* https://images.unsplash.com/photo-1616606103915-dea7be788566?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1887&q=80 */}
    </>
  );
};
